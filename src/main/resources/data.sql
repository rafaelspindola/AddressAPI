...
insert into Endereco (logradouro, cep, numero, cidade, principal, pessoa_id) values ('Rua C', '98765-098', '321', 'Ceará', TRUE, 2);
insert into Endereco (logradouro, cep, numero, cidade, principal, pessoa_id) values ('Rua D', '98765-077', '654', 'Pará', FALSE, 2);